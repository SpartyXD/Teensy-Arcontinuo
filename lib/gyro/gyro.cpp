...
void Gyro::begin() {
    Wire.begin();
    Serial.println("Initializing MPU6050 (GY-521)...");
    mpu.begin();
...
void Gyro::sendGyroDataAsMIDI() {
    ...
    usbMIDI.sendControlChange(117, midiX, 1);
    usbMIDI.sendControlChange(118, midiY, 1);
    usbMIDI.sendControlChange(119, midiZ, 1);
